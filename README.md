...
You can see your website, but it is not your custom domain URL
...
6. Wait for the status to turn to "Issued".
...
7. Enable a security option if you want extra protection from common web attacks like SQL injections, XSS, etc.
...
9. Wait for the status to turn Deployed
...
2.Log into your DNS provider (e.g., GoDaddy, Namecheap)
...
This helps keep your site healthy and performing.
